  ...
  return (
    ...
    <div className="flex items-center justify-between mb-8">
        <div>
            ...
            <p className="text-gray-600">Manage your farm properties and track their performance
                          </p>
        </div>
        <Button variant="primary" icon="Plus" onClick={() => setShowAddForm(true)}>Add Farm
                    </Button>
    </div>
    {/* Search Bar */}
    <div className="mb-6">
    ...
    {/* Farms Grid */}
    {filteredFarms.length === 0 ? <EmptyState
        icon="MapPin"
        ...
        onAction={!searchTerm ? () => setShowAddForm(true) : undefined} /> : <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredFarms.map((farm, index) => <motion.div
            key={farm.Id}
            initial={{
                opacity: 0,
                y: 20
